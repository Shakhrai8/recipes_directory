...
please refer to the recipes_directory_table_design.md in the recipes folder.
...
recipes[0].average_time # =>  '20'
recipes[0].ranking # =>  '4.5'

recipes[1].id # =>  2
recipes[1].name # =>  'Salad'
recipes[1].average_time # =>  '5'
recipes[1].ranking # =>  '3.7'
